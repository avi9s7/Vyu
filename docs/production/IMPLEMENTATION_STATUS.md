...
| 6 | Governed connectors and retrieval | in_progress | avi9s7 | pending | Plan 5 engineering complete | Task 3: production PubMed search/fetch and staging probe | Plan 5 operator staging evidence |
