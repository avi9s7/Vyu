...
| 4 | AWS infrastructure and deployment | in_progress | avi9s7 | https://github.com/avi9s7/Vyu/pull/4 | Plans 1-3 complete | PR #4 Task 1: Terraform module/environment skeleton; remote-state policy; infra structure tests | AWS account IDs; staging apply evidence |
