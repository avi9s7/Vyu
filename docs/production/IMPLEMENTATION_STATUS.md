...
| 6 | Governed connectors and retrieval | in_progress | avi9s7 | pending | Plan 5 engineering complete | Task 2: hardened connector HTTP runtime and rate limits | Plan 5 operator staging evidence |
