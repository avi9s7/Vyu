...
Last verified Git SHA: pending Plan 5 Task 3  
...
| 5 | Evidence ingestion | in_progress | avi9s7 | https://github.com/avi9s7/Vyu/pull/7 | Plan 4 code delivery; Plans 1–3 complete | Tasks 1–3: schema; presigned uploads; `ingestion.verify` object integrity worker | Plan 4 staging (for S3 live integration later) |
