...
Last verified Git SHA: pending push  
...
| 3 | FastAPI application and job platform | in_progress | avi9s7 | https://github.com/avi9s7/Vyu/compare/main...cursor/fastapi-jobs-plan-3 | Plan 2 complete | Branch `cursor/fastapi-jobs-plan-3`; Alembic `0003`; OpenAPI; auth/research/jobs tests; Docker/compose; CI trigger on `cursor/**`; local `verify.py --scope backend` OK | PR + green CI run URL |
