...
| 6 | Governed connectors and retrieval | in_progress | avi9s7 | pending | Plan 5 engineering complete | Task 1: versioned source/tool policy schema and import | Plan 5 operator staging evidence |
